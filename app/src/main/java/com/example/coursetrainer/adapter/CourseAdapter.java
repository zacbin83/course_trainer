package com.example.coursetrainer.adapter;
...
import com.example.coursetrainer.activity.*;
...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    public void onBindViewHolder(CourseViewHolder holder, int position) {
        ...
        holder.textViewCapacity.setText(stringBuilder);        Log.d("CourseId", String.valueOf(course.getId()));
